...
export default function Calendar() {
  ...
  const [activeTab, setActiveTab] = useState<'transactions' | 'journal' | 'setup'>('transactions');
  ...
  const handleDateClick = (date: Date) => {
    ...
    // Force close before opening to ensure modal state is refreshed
  ...
  return (
    ...
    >
      <div className="h-full min-h-0 overflow-visible bg-[#1A1B1E] p-2 sm:p-4">
        <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 h-full overflow-auto">
