...
export function DayNoteDialog({ isOpen, onClose, onSave }: DayNoteDialogProps) {
  ...
  return (
    <Transition appear show={isOpen} as={Fragment}>
      <Dialog as="div" className="relative z-50" onClose={onClose} style={dialogStyles}>
        <Transition.Child
          as={Fragment}
          ...
          leaveTo="opacity-0"
        >
          <div className="fixed inset-0 bg-black/80" style={{ zIndex: 99999 }} />
        </Transition.Child>
        ...
        <div className="fixed inset-0 overflow-y-auto" style={{ zIndex: 100000 }}>
          <div className="flex min-h-full items-center justify-center p-4">
            ...
            >
              <Dialog.Panel className="w-full max-w-lg bg-[#1A1B23] rounded-lg shadow-xl overflow-hidden" style={{ zIndex: 100000 }}>
                {/* Header */}
